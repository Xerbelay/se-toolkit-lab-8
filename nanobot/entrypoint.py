...
def main():
    ...
    lms["args"] = ["-m", "mcp_lms", os.environ.get("NANOBOT_LMS_BACKEND_URL", "http://backend:80")]
    lms["env"] = {
        "NANOBOT_LMS_BACKEND_URL": os.environ.get("NANOBOT_LMS_BACKEND_URL", "http://backend:80"),
